                ...
                <div class="user border-2 mb-[20px] rounded-2xl">
                    ...
                    <div class="log in p-5">
                        ...
                        <?php if (isset($_SESSION['users'])) { ?>
                            ...
                            <br>
                            <a href="logout.php"><button class="border-2 rounded-2xl p-2 bg-blue-200 mt-[20px]">Đăng xuất</button></a>
                    ...
                    <div class="grid grid-cols-3 gap-2 p-5 items-center">
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="text-while-500">
                                <li class="pb-4"><i class="fa fa-chevron-right text-green-500"></i><a href="#"
                                        class="hover:text-green-500"> Trang Chủ</a></li>
                                <li class="pb-4"><i class="fa fa-chevron-right text-green-500"></i><a href="#"
                                        class="hover:text-green-500"> Giới Thiệu</a></li>
                                <li class="pb-4"><i class="fa fa-chevron-right text-green-500"></i><a href="#"
                                        class="hover:text-green-500"> Liên Hệ</a></li>
                                <li class="pb-4"><i class="fa fa-chevron-right text-green-500"></i><a href="#"
                                        class="hover:text-green-500"> Góp Ý</a></li>
                                <li class="pb-4"><i class="fa fa-chevron-right text-green-500"></i><a href="#"
                                        class="hover:text-green-500"> Hỏi Đáp</a></li>
                            </ul>
                        ...
                        <div class="mb-5">
                            ...
                            <form action="#" class="flex flex-row flex-wrap">
                                <input type="text" class="text-black  w-2/3 p-2 focus:border-yellow-500"
                                    placeholder="email@xample.com" required>
                                <button
                                    class="p-2 w-1/3 bg-yellow-500 text-black hover:bg-yellow-600 font-bold">Subscribe</button>
                            </form>
                        </div>
                    </div>
            ...
            <div class="w-full bg-emerald-900 text-gray-300 px-10">
                <div class="max-w-7xl flex  flex-row py-4 mx-auto justify-between items-center">
                    ...
                    <div class="text-center text-xl text-white mb-2">
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-yellow-500 hover:bg-yellow-600 mx-1 inline-block pt-1"><i
